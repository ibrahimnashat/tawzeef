...
class CompanyOrPharmacyNotificationScreen extends StatefulWidget {
  const CompanyOrPharmacyNotificationScreen({Key? key}) : super(key: key);

  @override
  State<CompanyOrPharmacyNotificationScreen> createState() =>
      _CompanyOrPharmacyNotificationScreenState();
}

class _CompanyOrPharmacyNotificationScreenState
    extends State<CompanyOrPharmacyNotificationScreen> {
  late AutoDisposeChangeNotifierProvider<
          CompanyOrPharnamcyNotificationsScreenModel> notificationsController =
      AutoDisposeChangeNotifierProvider<
              CompanyOrPharnamcyNotificationsScreenModel>(
          (ref) => CompanyOrPharnamcyNotificationsScreenModel(context));
  @override
