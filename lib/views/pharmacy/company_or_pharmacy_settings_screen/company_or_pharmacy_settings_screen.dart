...
class CompanyOrPharmacySettingsScreen extends StatelessWidget {
  CompanyOrPharmacySettingsScreen({Key? key}) : super(key: key);
          ...
          Row(
            ...
            children: [
              ...
              MSvg(
                ...
                onTap: () => context.push(PharmacistChangePasswordScreen()),
              ),
          const Divider(),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
