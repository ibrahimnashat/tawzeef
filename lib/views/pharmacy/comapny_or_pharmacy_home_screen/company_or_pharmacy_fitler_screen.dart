...
class CompanyOrPharmacyFilterScreen extends ConsumerWidget {
  final AutoDisposeChangeNotifierProvider<CompanyOrPharnamcyHomeScreenModel>
      homeController;
  const CompanyOrPharmacyFilterScreen({
    Key? key,
