...
class _AddLinksScreenState extends State<AddLinksScreen> {
  late AutoDisposeChangeNotifierProvider<EditMyCompanyScreenModel>
      editCompanyController =
      AutoDisposeChangeNotifierProvider<EditMyCompanyScreenModel>(
          (ref) => EditMyCompanyScreenModel(context));
