...
class _CompanyNotificationScreenState extends State<CompanyNotificationScreen> {
  late AutoDisposeChangeNotifierProvider<CompanyNotificationsScreenModel>
      notificationsController =
      AutoDisposeChangeNotifierProvider<CompanyNotificationsScreenModel>(
          (ref) => CompanyNotificationsScreenModel(context));
  @override
